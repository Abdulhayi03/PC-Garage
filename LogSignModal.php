                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="https://bit.ly/2LPn9Wu">PC Garage</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                                                "+92 0000000000" type="number" value="">
                                          </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"><b>TERMS AND CONDITION</b></a> of PC Garage.</small>
