        ...
        <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                             <input class="form-control input-sm" id="PRODNAME" name="PRODNAME" type="text" value="<?php echo $singleproduct->PRODNAME; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="BRNAME" id="BRNAME">
                          <option value="None">Select Brand</option>
                          <?php
                            //Statement

                         $brand = New Brand();
                          $singlebrand = $brand->single_brand($singleproduct->BRID);
                          echo  '<option SELECTED  value='.$singlebrand->BRID.' >'.$singlebrand->BRNAME.'</option>';


                          $mydb->setQuery("SELECT * FROM `tblbrand` where BRID <> '".$singlebrand->BRID."'");
                          $cur = $mydb->loadResultList();
                        foreach ($cur as $result) {
                          echo  '<option  value='.$result->BRID.' >'.$result->BRNAME.'</option>';
                          }
                          ?>
